...
}, a = (h, v, s, w) => (p(h, v, "write to private field"), w ? w.call(h, s) : v.set(h, s), s);
var x = (h, v, s) => (p(h, v, "access private method"), s);
const $ = "Rivet Icons", V = "rvt-icon", c = "name", H = "rvtIconRegistered", u = /* @__PURE__ */ new Map(), m = /* @__PURE__ */ new Map(), C = document.createElement("template");
C.innerHTML = `
	<style>
		:host,
		.container {
...
function t(h, v) {
  ...
  if (s.innerHTML = v, s.content.children.length !== 1)
    throw new Error(`${$} (${h}): Content must contain one SVG element.`);
  if (s.content.firstChild.nodeName.toLowerCase() !== "svg")
    throw new Error(`${$} (${h}): Content must be a SVG element.`);
  m.set(h, s);
  const w = m.size;
  u.set(w, h), M.sheet.insertRule(`${V} { --${h}: ${w}; }`);
...
class B extends window.HTMLElement {
  constructor() {
    ...
    s.appendChild(C.content.cloneNode(!0)), a(this, e, s.querySelector(".container")), a(this, g, s.querySelector(".sensor")), a(this, l, A(x(this, Z, L).bind(this)));
  }
  static get observedAttributes() {
    return [c];
  }
  connectedCallback() {
    o(this, g).addEventListener("transitionstart", o(this, l)), document.addEventListener(H, o(this, l)), o(this, l).call(this);
  }
  disconnectedCallback() {
    o(this, g).removeEventListener("transitionstart", o(this, l)), document.removeEventListener(H, o(this, l));
  }
  attributeChangedCallback() {
    o(this, l).call(this);
  }
}
e = new WeakMap(), i = new WeakMap(), l = new WeakMap(), g = new WeakMap(), d = new WeakSet(), f = function() {
  if (!o(this, g))
    return;
  const s = window.getComputedStyle(o(this, g)).getPropertyValue(`--${c}`);
  return u.get(parseInt(s));
}, Z = new WeakSet(), L = function() {
  const s = x(this, d, f).call(this) || this.getAttribute(c);
  if (!o(this, e) || !m.has(s) || o(this, i) === s)
    return;
  const w = m.get(s).content.cloneNode(!0);
  o(this, e).replaceChildren(w);
  const r = o(this, e).querySelector("svg");
  r.setAttribute("aria-hidden", "true"), r.setAttribute("focusable", "false"), a(this, i, s);
};
window.customElements.define(V, B);
function A(h) {
  let v = !1;
  return function(...s) {
...
`;
t(b, k);
const y = "alarm-solid", E = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(y, E);
const N = "arrow-anchor-down-left", S = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M13 10V2h2v10H4.414l1.793 1.793-1.414 1.414L.586 11l4.207-4.207 1.414 1.414L4.414 10H13Z"/>
</svg>
`;
t(N, S);
const q = "arrow-anchor-down-right", T = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M1 2h2v8h8.586L9.793 8.207l1.414-1.414L15.414 11l-4.207 4.207-1.414-1.414L11.586 12H1V2Z"/>
</svg>
`;
t(q, T);
const R = "arrow-anchor-up-left", I = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="m4.414 6 1.793 1.793-1.414 1.414L.586 5 4.793.793l1.414 1.414L4.414 4H15v10h-2V6H4.414Z"/>
</svg>
`;
t(R, I);
const z = "arrow-anchor-up-right", F = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(b1, k1);
const y1 = "bus", E1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(y1, E1);
const N1 = "calendar", S1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(N1, S1);
const q1 = "calendar-solid", T1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M6 1a1 1 0 0 0-2 0v1H1v13h14V2h-3V1a1 1 0 1 0-2 0v1H6V1ZM3 6h10v2H3V6Zm2 6.5v-2h2v2H5Zm4 0v-2h2v2H9Z"/>
</svg>
`;
t(q1, T1);
const R1 = "caution", I1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(R1, I1);
const z1 = "caution-solid", F1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(b0, k0);
const y0 = "code", E0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(y0, E0);
const N0 = "collapse", S0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="m.586 14 3-3H1V9h6v6H5v-2.586l-3 3L.586 14ZM15.414 2l-3 3H15v2H9V1h2v2.586l3-3L15.414 2Z"/>
</svg>
`;
t(N0, S0);
const q0 = "copy", T0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M11 0H0v11h3V9H2V2h7v1h2V0Z"/>
  <path d="M16 5H5v11h11V5Zm-9 9V7h7v7H7Z"/>
</svg>
`;
t(q0, T0);
const R0 = "copy-solid", I0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M11 0H0v11h3V9H2V2h7v1h2V0Z"/>
  <path d="M5 5h11v11H5V5Z"/>
</svg>
`;
t(R0, I0);
const z0 = "credit-card", F0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(b2, k2);
const y2 = "filter-solid", E2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(y2, E2);
const N2 = "flag", S2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M5 1v1h9.387l-1.333 4 1.333 4H5v5H3V1h2Zm0 3v4h6.613l-.667-2 .667-2H5Z"/>
</svg>
`;
t(N2, S2);
const q2 = "flag-solid", T2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M5 2V1H3v14h2v-5h9.387l-1.333-4 1.333-4H5Z"/>
</svg>
`;
t(q2, T2);
const R2 = "gear", I2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M8 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/>
...
`;
t(R2, I2);
const z2 = "gear-solid", F2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(b6, k6);
const y6 = "info-circle-solid", E6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm7-3a1 1 0 1 0 2 0 1 1 0 0 0-2 0Zm2 2H7v5h2V7Z"/>
</svg>
`;
t(y6, E6);
const N6 = "laptop", S6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M1 3a2 2 0 0 1 2-2h10a2 2 0 0 1 2 2v6h1v6H0V9h1V3Zm1 8v2h12v-2h-2v1H4v-1H2Zm4-1h4V9h3V3H3v6h3v1Z"/>
</svg>
`;
t(N6, S6);
const q6 = "laptop-solid", T6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M3 1a2 2 0 0 0-2 2v6H0v6h16V9h-1V3a2 2 0 0 0-2-2H3ZM2 13v-2h2v1h8v-1h2v2H2Z"/>
</svg>
`;
t(q6, T6);
const R6 = "lightning", I6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M9.5 6.5 10 0H9L2 9.5h4.5L6 16h1l7-9.5H9.5Z"/>
</svg>
`;
t(R6, I6);
const z6 = "lightning-box", F6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(b3, k3);
const y3 = "neutral", E3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M5.5 9a1 1 0 1 0 0 2h5a1 1 0 1 0 0-2h-5ZM11 6a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM6 7a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z"/>
  <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0ZM2 8a6 6 0 1 1 12 0A6 6 0 0 1 2 8Z"/>
</svg>
`;
t(y3, E3);
const N3 = "neutral-solid", S3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(N3, S3);
const q3 = "newspaper", T3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(q3, T3);
const R3 = "newspaper-solid", I3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M16 1H4v2H0v9a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3V1ZM4 12a1 1 0 1 1-2 0V5h2v7Zm8-8v2H8V4h4Zm0 3v2H8V7h4Z"/>
</svg>
`;
t(R3, I3);
const z3 = "note", F3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(bt, kt);
const yt = "printer-solid", Et = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M13 0H3v4H0v9h3v3h10v-3h3V4h-3V0Zm0 8a1 1 0 1 1-2 0 1 1 0 0 1 2 0Zm-2-4H5V2h6v2Zm0 10H5v-2h6v2Z"/>
</svg>
`;
t(yt, Et);
const Nt = "question-mark", St = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(Nt, St);
const qt = "question-mark-solid", Tt = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(qt, Tt);
const Rt = "redo", It = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(Rt, It);
const zt = "rss", Ft = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(b4, k4);
const y4 = "transfer", E4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(y4, E4);
const N4 = "transfer-alt", S4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(N4, S4);
const q4 = "trash", T4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(q4, T4);
const R4 = "trash-solid", I4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(R4, I4);
const z4 = "undo", F4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
