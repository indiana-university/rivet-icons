...
}, a = (h, v, s, g) => (Z(h, v, "write to private field"), g ? g.call(h, s) : v.set(h, s), s);
var p = (h, v, s) => (Z(h, v, "access private method"), s);
const x = "Rivet Icons", H = "rvt-icon", r = "name", $ = "rvtIconRegistered";
const u = /* @__PURE__ */ new Map(), c = /* @__PURE__ */ new Map(), f = document.createElement("template");
f.innerHTML = `
<style>
:host,
.container {
...
function t(h, v) {
  if (!h || typeof h != "string")
    throw new Error(`${x}: Name must be a string.`);
  const s = document.createElement("template");
  if (s.innerHTML = v, s.content.children.length !== 1)
    throw new Error(`${x} (${h}): Content must contain one SVG element.`);
  const g = s.content.firstChild;
  if (g.nodeName.toLowerCase() !== "svg")
    throw new Error(`${x} (${h}): Content must be a SVG element.`);
  k(g, {
    "aria-hidden": "true",
    fill: "currentColor",
    focusable: "false",
  ...
  const M = c.size;
  u.set(M, h), V.sheet.insertRule(`${H} { --${h}: ${M}; }`);
...
class A extends window.HTMLElement {
  constructor() {
    ...
    s.appendChild(f.content.cloneNode(!0)), a(this, e, s.querySelector(".container")), a(this, w, s.querySelector(".sensor")), a(this, l, y(p(this, d, L).bind(this)));
  }
...
e = new WeakMap(), i = new WeakMap(), l = new WeakMap(), w = new WeakMap(), m = new WeakSet(), C = function() {
  if (!o(this, w))
    return;
  const s = window.getComputedStyle(o(this, w)).getPropertyValue(`--${r}`);
  return u.get(parseInt(s));
}, d = new WeakSet(), L = function() {
  const s = p(this, m, C).call(this) || this.getAttribute(r);
  if (!o(this, e) || !c.has(s) || o(this, i) === s)
    return;
  const g = c.get(s).content.cloneNode(!0);
  o(this, e).replaceChildren(g), a(this, i, s);
};
window.customElements.define(H, A);
function b(h, v, s) {
  h.hasAttribute(v) || h.setAttribute(v, s);
}
function k(h, v) {
  Object.entries(v).forEach(([s, g]) => {
    b(h, s, g);
  });
}
function y(h) {
...
const E = "alarm", N = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(E, N);
const z = "alarm-solid", S = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(z, S);
const T = "arrow-anchor-down-left", q = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(R, I);
const F = "arrow-anchor-up-left", D = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="m4.414 6 1.793 1.793-1.414 1.414L.586 5 4.793.793l1.414 1.414L4.414 4H15v10h-2V6H4.414Z"/>
</svg>
`;
t(F, D);
const G = "arrow-anchor-up-right", j = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M11.207.793 15.414 5l-4.207 4.207-1.414-1.414L11.586 6H3v8H1V4h10.586L9.793 2.207 11.207.793Z"/>
</svg>
`;
t(G, j);
const O = "arrow-down", P = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(U, J);
const K = "arrow-down-right", Q = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M3.707 2.293 12 10.586V4h2v10H4v-2h6.586L2.293 3.707l1.414-1.414Z"/>
</svg>
`;
t(K, Q);
const W = "arrow-left", X = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M15 7H4.156l4.107-4.854L6.737.854.69 8l6.047 7.146 1.526-1.292L4.156 9H15V7Z"/>
</svg>
`;
t(W, X);
const Y = "arrow-right", _ = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M1 7h10.844L7.737 2.146 9.263.854 15.31 8l-6.047 7.146-1.526-1.292L11.844 9H1V7Z"/>
</svg>
`;
t(Y, _);
const t1 = "arrow-up", s1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M9 15V4.156l4.854 4.107 1.292-1.526L8 .69.854 6.737l1.292 1.526L7 4.156V15h2Z"/>
</svg>
`;
t(t1, s1);
const h1 = "arrow-up-left", v1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M2 2h10v2H5.414l8.293 8.293-1.414 1.414L4 5.414V12H2V2Z"/>
</svg>
`;
t(h1, v1);
const o1 = "arrow-up-right", l1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M10.586 4H4V2h10v10h-2V5.414l-8.293 8.293-1.414-1.414L10.586 4Z"/>
</svg>
`;
t(o1, l1);
const g1 = "audio", w1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(g1, w1);
const n1 = "audio-off", e1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(n1, e1);
const a1 = "audio-off-solid", i1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(a1, i1);
const r1 = "audio-solid", c1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M10 16v-5.401A2.999 2.999 0 0 0 10 5.4V0L4.667 4H0v8h4.667L10 16Z"/>
  <path d="m13.6 3.2-.799-.6L11.6 4.199l.8.6a4 4 0 0 1 .8.802c.503.668.8 1.497.8 2.399 0 .902-.297 1.73-.8 2.4a4.03 4.03 0 0 1-.8.8l-.8.601 1.201 1.6.8-.601a6.028 6.028 0 0 0 1.198-1.2A5.977 5.977 0 0 0 16 8c0-1.35-.447-2.598-1.2-3.6a6.03 6.03 0 0 0-1.2-1.2Z"/>
</svg>
`;
t(r1, c1);
const m1 = "ban", d1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(m1, d1);
const Z1 = "ban-solid", p1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(Z1, p1);
const x1 = "bell", $1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(x1, $1);
const H1 = "bell-solid", V1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(H1, V1);
const M1 = "bookmark", u1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="m13 15.563-5-2.308-5 2.308V1h10v14.563ZM11 3H5v9.437l3-1.384 3 1.384V3Z"/>
</svg>
`;
t(M1, u1);
const f1 = "bookmark-solid", C1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M13 15.563V1H3v14.563l5-2.308 5 2.308Z"/>
</svg>
`;
t(f1, C1);
const L1 = "browser-window", B1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(L1, B1);
const A1 = "browser-window-solid", b1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M1 1h14v14H1V1Zm5 3a1 1 0 1 0-2 0 1 1 0 0 0 2 0Zm3 0a1 1 0 1 0-2 0 1 1 0 0 0 2 0Zm4 3H3v2h10V7Z"/>
</svg>
`;
t(A1, b1);
const k1 = "building", y1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(k1, y1);
const E1 = "building-solid", N1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M2 0h12v14h1v2H1v-2h1V0Zm5 4H5v2h2V4Zm4 0H9v2h2V4ZM7 7H5v2h2V7Zm4 0H9v2h2V7Zm-2 5a1 1 0 1 0-2 0v2h2v-2Z"/>
</svg>
`;
t(E1, N1);
const z1 = "bus", S1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(z1, S1);
const T1 = "calendar", q1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(R1, I1);
const F1 = "caution", D1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(F1, D1);
const G1 = "caution-solid", j1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M6.382 0h3.236L16 12.764V16H0v-3.236L6.382 0ZM7 6v4h2V6H7Zm1 7a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z"/>
</svg>
`;
t(G1, j1);
const O1 = "chat", P1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(U1, J1);
const K1 = "check", Q1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="m14.914 4-9.47 9.47L1.09 8.393 2.608 7.09l2.948 3.44L13.5 2.585 14.914 4Z"/>
</svg>
`;
t(K1, Q1);
const W1 = "check-all", X1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(W1, X1);
const Y1 = "check-circle", _1 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(Y1, _1);
const t0 = "check-circle-breakout", s0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(t0, s0);
const h0 = "check-circle-solid", v0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm7 3.414L11.914 6.5 10.5 5.086 7 8.586l-1.5-1.5L4.086 8.5 7 11.414Z"/>
</svg>
`;
t(h0, v0);
const o0 = "chevron-down", l0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="m15.146 6.263-1.292-1.526L8 9.69 2.146 4.737.854 6.263 8 12.31l7.146-6.047Z"/>
</svg>
`;
t(o0, l0);
const g0 = "chevron-left", w0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M9.737.854 3.69 8l6.047 7.146 1.526-1.292L6.31 8l4.953-5.854L9.737.854Z"/>
</svg>
`;
t(g0, w0);
const n0 = "chevron-right", e0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M6.263 15.146 12.31 8 6.263.854 4.737 2.146 9.69 8l-4.953 5.854 1.526 1.292Z"/>
</svg>
`;
t(n0, e0);
const a0 = "chevron-up", i0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M15.146 10.737 8 4.69.854 10.737l1.292 1.526L8 7.31l5.854 4.953 1.292-1.526Z"/>
</svg>
`;
t(a0, i0);
const r0 = "chevrons-left", c0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M.586 8 7 14.414 8.414 13l-5-5 5-5L7 1.586.586 8Z"/>
  <path d="M6.586 8 13 14.414 14.414 13l-5-5 5-5L13 1.586 6.586 8Z"/>
</svg>
`;
t(r0, c0);
const m0 = "chevrons-right", d0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M9.414 8 3 1.586 1.586 3l5 5-5 5L3 14.414 9.414 8Z"/>
  <path d="M15.414 8 9 1.586 7.586 3l5 5-5 5L9 14.414 15.414 8Z"/>
</svg>
`;
t(m0, d0);
const Z0 = "circle", p0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M8 2a6 6 0 1 0 0 12A6 6 0 0 0 8 2ZM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Z"/>
</svg>
`;
t(Z0, p0);
const x0 = "circle-solid", $0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0Z"/>
</svg>
`;
t(x0, $0);
const H0 = "clipboard", V0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(H0, V0);
const M0 = "clipboard-solid", u0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M4 2a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2h3v14H1V2h3Zm6 1V2H6v1h4ZM5 7v2h6V7H5Zm0 3v2h6v-2H5Z"/>
</svg>
`;
t(M0, u0);
const f0 = "clock", C0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M9 7.586V4H7v4.414l2.5 2.5L10.914 9.5 9 7.586Z"/>
  <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0ZM2 8a6 6 0 1 1 12 0A6 6 0 0 1 2 8Z"/>
</svg>
`;
t(f0, C0);
const L0 = "clock-solid", B0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm9-.414V4H7v4.414l2.5 2.5L10.914 9.5 9 7.586Z"/>
</svg>
`;
t(L0, B0);
const A0 = "close", b0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(A0, b0);
const k0 = "close-circle", y0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="m8 6.586-2-2L4.586 6l2 2-2 2L6 11.414l2-2 2 2L11.414 10l-2-2 2-2L10 4.586l-2 2Z"/>
  <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0ZM2 8a6 6 0 1 1 12 0A6 6 0 0 1 2 8Z"/>
</svg>
`;
t(k0, y0);
const E0 = "close-circle-solid", N0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm8-1.414-2-2L4.586 6l2 2-2 2L6 11.414l2-2 2 2L11.414 10l-2-2 2-2L10 4.586l-2 2Z"/>
</svg>
`;
t(E0, N0);
const z0 = "code", S0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(z0, S0);
const T0 = "collapse", q0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(R0, I0);
const F0 = "copy-solid", D0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M11 0H0v11h3V9H2V2h7v1h2V0Z"/>
  <path d="M5 5h11v11H5V5Z"/>
</svg>
`;
t(F0, D0);
const G0 = "credit-card", j0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M0 2h16v12H0V2Zm2 2v2h10v2H2v4h12V4H2Z"/>
</svg>
`;
t(G0, j0);
const O0 = "credit-card-solid", P0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(U0, J0);
const K0 = "data", Q0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(K0, Q0);
const W0 = "data-solid", X0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(W0, X0);
const Y0 = "device", _0 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(Y0, _0);
const t2 = "device-solid", s2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(t2, s2);
const h2 = "download", v2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(h2, v2);
const o2 = "ellipsis", l2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M4 8a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm6 0a2 2 0 1 1-4 0 2 2 0 0 1 4 0Zm4 2a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/>
</svg>
`;
t(o2, l2);
const g2 = "ellipsis-vertical", w2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M10 2a2 2 0 1 0-4 0 2 2 0 0 0 4 0ZM8 6a2 2 0 1 1 0 4 2 2 0 0 1 0-4Zm0 6a2 2 0 1 1 0 4 2 2 0 0 1 0-4Z"/>
</svg>
`;
t(g2, w2);
const n2 = "envelope", e2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M0 2v12h16V2H0Zm2 2.023V4h12v.023L8 7.356 2 4.023ZM2 6.31l6 3.333 6-3.333V12H2V6.31Z"/>
</svg>
`;
t(n2, e2);
const a2 = "envelope-solid", i2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M0 2h16v.912L8 7.356 0 2.912V2Z"/>
  <path d="M0 5.2V14h16V5.2L8 9.644 0 5.199Z"/>
</svg>
`;
t(a2, i2);
const r2 = "exclamation-mark", c2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M9 11V1H7v10h2Zm-1 4a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z"/>
</svg>
`;
t(r2, c2);
const m2 = "exclamation-mark-circle", d2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(m2, d2);
const Z2 = "exclamation-mark-circle-solid", p2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm7 1h2V4H7v5Zm2 2a1 1 0 1 0-2 0 1 1 0 0 0 2 0Z"/>
</svg>
`;
t(Z2, p2);
const x2 = "expand", $2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="m11.586 3-3 3L10 7.414l3-3V7h2V1H9v2h2.586ZM4.414 13l3-3L6 8.586l-3 3V9H1v6h6v-2H4.414Z"/>
</svg>
`;
t(x2, $2);
const H2 = "eye", V2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(H2, V2);
const M2 = "eye-off", u2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(M2, u2);
const f2 = "eye-off-solid", C2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(f2, C2);
const L2 = "eye-solid", B2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(L2, B2);
const A2 = "file", b2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M2 1h8.414L14 4.586V15H2V1Zm2 2v10h8V7.5H7.5V3H4Zm5.5 0v2.5H12v-.086L9.586 3H9.5Z"/>
</svg>
`;
t(A2, b2);
const k2 = "file-solid", y2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M10.414 1H2v14h12V4.586L10.414 1ZM9.5 5.5V3h.086L12 5.414V5.5H9.5Z"/>
</svg>
`;
t(k2, y2);
const E2 = "filter", N2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(E2, N2);
const z2 = "filter-solid", S2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(z2, S2);
const T2 = "flag", q2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(R2, I2);
const F2 = "gear", D2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M8 10a2 2 0 1 0 0-4 2 2 0 0 0 0 4Z"/>
...
`;
t(F2, D2);
const G2 = "gear-solid", j2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(G2, j2);
const O2 = "gears", P2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(U2, J2);
const K2 = "globe-solid", Q2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(K2, Q2);
const W2 = "grid", X2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M7 0H0v7h7V0ZM2 5V2h3v3H2Zm14-5H9v7h7V0Zm-5 5V2h3v3h-3ZM9 9h7v7H9V9Zm2 2v3h3v-3h-3ZM7 9H0v7h7V9Zm-5 5v-3h3v3H2Z"/>
</svg>
`;
t(W2, X2);
const Y2 = "grid-horizontal", _2 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(Y2, _2);
const t6 = "grid-solid", s6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M0 0h7v7H0V0Zm9 0h7v7H9V0Zm7 9H9v7h7V9ZM0 9h7v7H0V9Z"/>
</svg>
`;
t(t6, s6);
const h6 = "grid-vertical", v6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(h6, v6);
const o6 = "happy", l6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(o6, l6);
const g6 = "happy-solid", w6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(g6, w6);
const n6 = "headphones", e6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(n6, e6);
const a6 = "headphones-solid", i6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(a6, i6);
const r6 = "heart", c6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(r6, c6);
const m6 = "heart-solid", d6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(m6, d6);
const Z6 = "home", p6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="m8 .798 7 4.667V15H9v-4.444H7V15H1V5.465L8 .798ZM3 6.535V13h2V8.556h6V13h2V6.535L8 3.202 3 6.535Z"/>
</svg>
`;
t(Z6, p6);
const x6 = "home-solid", $6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M15 5.465 8 .798 1 5.465V15h6v-4.444h2V15h6V5.465Z"/>
</svg>
`;
t(x6, $6);
const H6 = "image", V6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(H6, V6);
const M6 = "image-solid", u6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M1 1h14v14H1V1Zm11 5a2 2 0 1 0-4 0 2 2 0 0 0 4 0Zm-9 7h10v-.465l-2.072-1.381-2.086 1.043-4.376-3.89L3 9.482V13Z"/>
</svg>
`;
t(M6, u6);
const f6 = "inbox", C6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(f6, C6);
const L6 = "inbox-complete", B6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M8 6.914 13.414 1.5 12 .086l-4 4-2-2L4.586 3.5 8 6.914ZM6 8H0v8h16V8h-6v2H6V8Zm6 4v-2h2v4H2v-4h2v2h8Z"/>
</svg>
`;
t(L6, B6);
const A6 = "inbox-complete-solid", b6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M13.414 1.5 12 .086l-4 4-2-2L4.586 3.5 8 6.914 13.414 1.5ZM0 8h6v2h4V8h6v8H0V8Z"/>
</svg>
`;
t(A6, b6);
const k6 = "inbox-solid", y6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M9 4.086V0H7v4.086l-1.5-1.5L4.086 4 8 7.914 11.914 4 10.5 2.586 9 4.086ZM0 8h6v2h4V8h6v8H0V8Z"/>
</svg>
`;
t(k6, y6);
const E6 = "info-circle", N6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M9 7v5H7V7h2ZM8 4a1 1 0 1 0 0 2 1 1 0 0 0 0-2Z"/>
  <path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm8-6a6 6 0 1 0 0 12A6 6 0 0 0 8 2Z"/>
</svg>
`;
t(E6, N6);
const z6 = "info-circle-solid", S6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm7-3a1 1 0 1 0 2 0 1 1 0 0 0-2 0Zm2 2H7v5h2V7Z"/>
</svg>
`;
t(z6, S6);
const T6 = "laptop", q6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(R6, I6);
const F6 = "lightning", D6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M9.5 6.5 10 0H9L2 9.5h4.5L6 16h1l7-9.5H9.5Z"/>
</svg>
`;
t(F6, D6);
const G6 = "lightning-box", j6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M8.5 4 5 9h2v3h.5L11 7H9V4h-.5Z"/>
  <path d="M15 1H1v14h14V1ZM3 13V3h10v10H3Z"/>
</svg>
`;
t(G6, j6);
const O6 = "lightning-box-solid", P6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(U6, J6);
const K6 = "link-external", Q6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M15 1H9v2h2.586l-3 3L10 7.414l3-3V7h2V1Z"/>
  <path d="M7 3H1v12h12V9h-2v4H3V5h4V3Z"/>
</svg>
`;
t(K6, Q6);
const W6 = "list", X6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(W6, X6);
const Y6 = "lock-closed", _6 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(Y6, _6);
const t3 = "lock-closed-solid", s3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(t3, s3);
const h3 = "lock-open", v3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M9 10a1 1 0 1 0-2 0v1a1 1 0 1 0 2 0v-1Z"/>
...
`;
t(h3, v3);
const o3 = "lock-open-solid", l3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(o3, l3);
const g3 = "magnifying-glass", w3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M7 2a5 5 0 1 0 0 10A5 5 0 0 0 7 2ZM0 7a7 7 0 1 1 12.606 4.192l3.101 3.1-1.414 1.415-3.1-3.1A7 7 0 0 1 0 7Z"/>
</svg>
`;
t(g3, w3);
const n3 = "map-pin", e3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(n3, e3);
const a3 = "map-pin-solid", i3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(a3, i3);
const r3 = "megaphone", c3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(r3, c3);
const m3 = "megaphone-solid", d3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(m3, d3);
const Z3 = "menu", p3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M15 4H1V2h14v2Zm0 5H1V7h14v2ZM1 14h14v-2H1v2Z"/>
</svg>
`;
t(Z3, p3);
const x3 = "microphone", $3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(x3, $3);
const H3 = "microphone-off", V3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(H3, V3);
const M3 = "microphone-off-solid", u3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(M3, u3);
const f3 = "microphone-solid", C3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M5 3a3 3 0 0 1 6 0v4a3 3 0 0 1-6 0V3Z"/>
  <path d="M8 11a4 4 0 0 1-4-4H2a6.002 6.002 0 0 0 5 5.917V14H5v2h6v-2H9v-1.083A6.002 6.002 0 0 0 14 7h-2a4 4 0 0 1-4 4Z"/>
</svg>
`;
t(f3, C3);
const L3 = "minus", B3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M15 9H1V7h14v2Z"/>
</svg>
`;
t(L3, B3);
const A3 = "minus-circle", b3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M12 7H4v2h8V7Z"/>
  <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0ZM2 8a6 6 0 1 1 12 0A6 6 0 0 1 2 8Z"/>
</svg>
`;
t(A3, b3);
const k3 = "minus-circle-solid", y3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm12-1H4v2h8V7Z"/>
</svg>
`;
t(k3, y3);
const E3 = "money", N3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(E3, N3);
const z3 = "neutral", S3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M5.5 9a1 1 0 1 0 0 2h5a1 1 0 1 0 0-2h-5ZM11 6a1 1 0 1 1-2 0 1 1 0 0 1 2 0ZM6 7a1 1 0 1 0 0-2 1 1 0 0 0 0 2Z"/>
  <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0ZM2 8a6 6 0 1 1 12 0A6 6 0 0 1 2 8Z"/>
</svg>
`;
t(z3, S3);
const T3 = "neutral-solid", q3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(R3, I3);
const F3 = "newspaper-solid", D3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M16 1H4v2H0v9a3 3 0 0 0 3 3h10a3 3 0 0 0 3-3V1ZM4 12a1 1 0 1 1-2 0V5h2v7Zm8-8v2H8V4h4Zm0 3v2H8V7h4Z"/>
</svg>
`;
t(F3, D3);
const G3 = "note", j3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M10 8H6V6h4v2Zm0 3H6V9h4v2Z"/>
  <path d="M10.414 1H2v14h12V4.586L10.414 1ZM4 13V3h5.586L12 5.414V13H4Z"/>
</svg>
`;
t(G3, j3);
const O3 = "note-solid", P3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(U3, J3);
const K3 = "page-bottom", Q3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M1 3h14V1H1v2Zm8 8.826V5H7v6.826L4.392 9.59 3.09 11.108 8 15.319l4.91-4.21-1.302-1.518L9 11.826Z"/>
</svg>
`;
t(K3, Q3);
const W3 = "page-top", X3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M1 3h14V1H1v2Zm6 5.174V15h2V8.174l2.608 2.236 1.302-1.518L8 4.682l-4.91 4.21 1.302 1.518L7 8.174Z"/>
</svg>
`;
t(W3, X3);
const Y3 = "parking", _3 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M9 4H5v8h2v-2h2a3 3 0 1 0 0-6Zm0 4H7V6h2a1 1 0 0 1 0 2Z"/>
  <path d="M15 1H1v14h14V1ZM3 13V3h10v10H3Z"/>
</svg>
`;
t(Y3, _3);
const tt = "parking-solid", st = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M9 8H7V6h2a1 1 0 0 1 0 2Z"/>
  <path d="M1 1h14v14H1V1Zm8 3H5v8h2v-2h2a3 3 0 1 0 0-6Z"/>
</svg>
`;
t(tt, st);
const ht = "pause", vt = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M6 15V1H4v14h2Zm6 0V1h-2v14h2Z"/>
</svg>
`;
t(ht, vt);
const ot = "pencil", lt = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(ot, lt);
const gt = "pencil-solid", wt = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(gt, wt);
const nt = "phone", et = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M4 1h1l1.5 5L5 7c0 2 2 4 4 4l1-1.5 5 1.5v1a3 3 0 0 1-3 3C5 15 1 10 1 4a3 3 0 0 1 3-3Z"/>
</svg>
`;
t(nt, et);
const at = "phone-mobile", it = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(at, it);
const rt = "phone-mobile-solid", ct = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M2 2a2 2 0 0 1 2-2h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H4a2 2 0 0 1-2-2V2Zm4 11h4v-2H6v2Z"/>
</svg>
`;
t(rt, ct);
const mt = "pin", dt = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(mt, dt);
const Zt = "pin-solid", pt = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(Zt, pt);
const xt = "plane", $t = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M15.662 8 .684 15.815 1.986 8 .684.185 15.662 8ZM3.847 9l-.53 3.185L11.337 8 3.316 3.815 3.847 7H7v2H3.847Z"/>
</svg>
`;
t(xt, $t);
const Ht = "plane-solid", Vt = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M15.662 8 .684 15.815 1.82 9H7V7H1.82L.684.185 15.662 8Z"/>
</svg>
`;
t(Ht, Vt);
const Mt = "play", ut = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M15.662 8 1 15.65V.35L15.662 8Zm-4.324 0L3 3.65v8.7L11.338 8Z"/>
</svg>
`;
t(Mt, ut);
const ft = "play-solid", Ct = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M1 15.65 15.662 8 1 .35v15.3Z"/>
</svg>
`;
t(ft, Ct);
const Lt = "plus", Bt = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M7 7V.5h2V7h6.5v2H9v6.5H7V9H.5V7H7Z"/>
</svg>
`;
t(Lt, Bt);
const At = "plus-circle", bt = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M7 4v3H4v2h3v3h2V9h3V7H9V4H7Z"/>
  <path d="M8 0a8 8 0 1 0 0 16A8 8 0 0 0 8 0ZM2 8a6 6 0 1 1 12 0A6 6 0 0 1 2 8Z"/>
</svg>
`;
t(At, bt);
const kt = "plus-circle-solid", yt = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Zm7-4v3H4v2h3v3h2V9h3V7H9V4H7Z"/>
</svg>
`;
t(kt, yt);
const Et = "printer", Nt = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(Et, Nt);
const zt = "printer-solid", St = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M13 0H3v4H0v9h3v3h10v-3h3V4h-3V0Zm0 8a1 1 0 1 1-2 0 1 1 0 0 1 2 0Zm-2-4H5V2h6v2Zm0 10H5v-2h6v2Z"/>
</svg>
`;
t(zt, St);
const Tt = "question-mark", qt = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(Rt, It);
const Ft = "redo", Dt = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(Ft, Dt);
const Gt = "rss", jt = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(Gt, jt);
const Ot = "sad", Pt = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M8 2a6 6 0 1 0 0 12A6 6 0 0 0 8 2ZM0 8a8 8 0 1 1 16 0A8 8 0 0 1 0 8Z"/>
...
`;
t(Ut, Jt);
const Kt = "save", Qt = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M9 4H4v2h5V4Z"/>
  <path d="M10.414 1H1v14h14V5.586L10.414 1ZM3 13V3h6.586L13 6.414V13h-1V9H4v4H3Zm7-2v2H6v-2h4Z"/>
</svg>
`;
t(Kt, Qt);
const Wt = "save-solid", Xt = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M10.414 1H1v14h14V5.586L10.414 1ZM4 4h5v2H4V4Zm8 5v4h-2v-2H6v2H4V9h8Z"/>
</svg>
`;
t(Wt, Xt);
const Yt = "settings", _t = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(Yt, _t);
const t4 = "share", s4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(t4, s4);
const h4 = "share-solid", v4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(h4, v4);
const o4 = "shirt", l4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(o4, l4);
const g4 = "shirt-solid", w4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M5.447 1.106 5 .882l-5 2.5V9h3v6h10V9h3V3.382l-5-2.5-.447.224c-1.719.859-3.387.859-5.106 0Z"/>
</svg>
`;
t(g4, w4);
const n4 = "shopping-bag", e4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M4 4a4 4 0 1 1 8 0h4v12H0V4h4Zm0 2H2v8h12V6h-2v2h-2V6H6v2H4V6Zm6-2a2 2 0 1 0-4 0h4Z"/>
</svg>
`;
t(n4, e4);
const a4 = "shopping-bag-solid", i4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M4 4a4 4 0 1 1 8 0h4v12H0V4h4Zm4-2a2 2 0 0 0-2 2h4a2 2 0 0 0-2-2ZM4 6v2h2V6H4Zm6 0v2h2V6h-2Z"/>
</svg>
`;
t(a4, i4);
const r4 = "shopping-cart", c4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(r4, c4);
const m4 = "shopping-cart-solid", d4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(m4, d4);
const Z4 = "sidebyside", p4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M1 1h14v14H1V1Zm2 2v10h4V3H3Zm6 0v10h4V3H9Z"/>
</svg>
`;
t(Z4, p4);
const x4 = "sidebyside-solid", $4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M1 15V1h14v14H1ZM9 3H7v10h2V3Z"/>
</svg>
`;
t(x4, $4);
const H4 = "star", V4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(H4, V4);
const M4 = "star-solid", u4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(M4, u4);
const f4 = "sync", C4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(f4, C4);
const L4 = "thumbs-down", B4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(L4, B4);
const A4 = "thumbs-down-solid", b4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M12.5 10H16V1h-3.5v9Zm-2-9H1.617L.648 8.752A2 2 0 0 0 2.633 11H5v1a3 3 0 0 0 3 3h.677l1.823-4.557V1Z"/>
</svg>
`;
t(A4, b4);
const k4 = "thumbs-up", y4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(k4, y4);
const E4 = "thumbs-up-solid", N4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M7.323 1H8a3 3 0 0 1 3 3v1h2.367a2 2 0 0 1 1.985 2.248L14.382 15H5.5V5.557L7.323 1ZM3.5 6H0v9h3.5V6Z"/>
</svg>
`;
t(E4, N4);
const z4 = "transfer", S4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(z4, S4);
const T4 = "transfer-alt", q4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(R4, I4);
const F4 = "trash-solid", D4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(F4, D4);
const G4 = "undo", j4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(G4, j4);
const O4 = "upload", P4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(U4, J4);
const K4 = "user-add", Q4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(K4, Q4);
const W4 = "user-add-solid", X4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M1 4a4 4 0 1 1 8 0 4 4 0 0 1-8 0Zm-1 8a3 3 0 0 1 3-3h4a3 3 0 0 1 3 3v4H0v-4Zm16-4h-2v2h-2V8h-2V6h2V4h2v2h2v2Z"/>
</svg>
`;
t(W4, X4);
const Y4 = "user-group", _4 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(Y4, _4);
const t5 = "user-group-solid", s5 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(t5, s5);
const h5 = "user-remove", v5 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(h5, v5);
const o5 = "user-remove-solid", l5 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M1 4a4 4 0 1 1 8 0 4 4 0 0 1-8 0Zm-1 8a3 3 0 0 1 3-3h4a3 3 0 0 1 3 3v4H0v-4Zm10-4h6V6h-6v2Z"/>
</svg>
`;
t(o5, l5);
const g5 = "user-solid", w5 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M8 0a4 4 0 1 0 0 8 4 4 0 0 0 0-8ZM6 9a3 3 0 0 0-3 3v4h10v-4a3 3 0 0 0-3-3H6Z"/>
</svg>
`;
t(g5, w5);
const n5 = "utensils", e5 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(n5, e5);
const a5 = "utensils-solid", i5 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="m9.975 3.44 1.94-1.94L10.5.086l-1.94 1.94a3.501 3.501 0 0 0-.429 4.428L8 6.586l-5.5-5.5-.94.94a3.5 3.5 0 0 0 0 4.949L4.587 10l-4 4L2 15.414l4-4 2 2 2-2 4 4L15.414 14l-6-6 .132-.131a3.501 3.501 0 0 0 4.429-.43l1.94-1.939L14.5 4.086l-1.94 1.94a1.5 1.5 0 0 1-1.534.362L13.914 3.5 12.5 2.086 9.612 4.974a1.5 1.5 0 0 1 .363-1.535Z"/>
</svg>
`;
t(a5, i5);
const r5 = "video", c5 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
  <path d="M0 2h12v2.367l4-.5v8.266l-4-.5V14H0V2Zm2 2v8h8V9.367l4 .5V6.133l-4 .5V4H2Z"/>
</svg>
`;
t(r5, c5);
const m5 = "video-off", d5 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(m5, d5);
const Z5 = "video-off-solid", p5 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
...
`;
t(Z5, p5);
const x5 = "video-solid", $5 = `<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
