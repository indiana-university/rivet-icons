...
rvt-icon {
  ...
  --user-add-solid: 91;
  --user-remove: 92;
  --user-remove-solid: 93;
  --user-solid: 94;
  --users: 95;
  --users-group-solid: 96;
  --users-solid: 97;
  display: inline-flex;
}
...
.rvt-icon--arrow-down,
rvt-icon[icon="arrow-down"] {
  --rvt-icon: var(--arrow-down);
}

.rvt-icon--arrow-left,
rvt-icon[icon="arrow-left"] {
  --rvt-icon: var(--arrow-left);
}

.rvt-icon--arrow-right,
rvt-icon[icon="arrow-right"] {
  --rvt-icon: var(--arrow-right);
}

.rvt-icon--arrow-up,
rvt-icon[icon="arrow-up"] {
  --rvt-icon: var(--arrow-up);
}

.rvt-icon--audio-off,
rvt-icon[icon="audio-off"] {
  --rvt-icon: var(--audio-off);
}

.rvt-icon--audio-on,
rvt-icon[icon="audio-on"] {
  --rvt-icon: var(--audio-on);
}
...
.rvt-icon--building,
rvt-icon[icon="building"] {
  --rvt-icon: var(--building);
}

.rvt-icon--calendar,
rvt-icon[icon="calendar"] {
  --rvt-icon: var(--calendar);
}
...
.rvt-icon--check-all,
rvt-icon[icon="check-all"] {
  --rvt-icon: var(--check-all);
}

.rvt-icon--check-circle,
rvt-icon[icon="check-circle"] {
  --rvt-icon: var(--check-circle);
}

.rvt-icon--check-circle-breakout,
rvt-icon[icon="check-circle-breakout"] {
  --rvt-icon: var(--check-circle-breakout);
}

.rvt-icon--chevron-down,
rvt-icon[icon="chevron-down"] {
  --rvt-icon: var(--chevron-down);
}

.rvt-icon--chevron-left,
rvt-icon[icon="chevron-left"] {
  --rvt-icon: var(--chevron-left);
}

.rvt-icon--chevron-right,
rvt-icon[icon="chevron-right"] {
  --rvt-icon: var(--chevron-right);
}

.rvt-icon--chevron-up,
rvt-icon[icon="chevron-up"] {
  --rvt-icon: var(--chevron-up);
}

.rvt-icon--chevrons-left,
rvt-icon[icon="chevrons-left"] {
  --rvt-icon: var(--chevrons-left);
}

.rvt-icon--chevrons-right,
rvt-icon[icon="chevrons-right"] {
  --rvt-icon: var(--chevrons-right);
}

.rvt-icon--circle,
rvt-icon[icon="circle"] {
  --rvt-icon: var(--circle);
}

.rvt-icon--circle-solid,
rvt-icon[icon="circle-solid"] {
  --rvt-icon: var(--circle-solid);
}

.rvt-icon--clipboard,
rvt-icon[icon="clipboard"] {
  --rvt-icon: var(--clipboard);
}
...
.rvt-icon--close-circle,
rvt-icon[icon="close-circle"] {
  --rvt-icon: var(--close-circle);
}

.rvt-icon--close-circle-solid,
rvt-icon[icon="close-circle-solid"] {
  --rvt-icon: var(--close-circle-solid);
}
...
.rvt-icon--credit-card,
rvt-icon[icon="credit-card"] {
  --rvt-icon: var(--credit-card);
}
...
.rvt-icon--download,
rvt-icon[icon="download"] {
  --rvt-icon: var(--download);
}

.rvt-icon--ellipsis,
rvt-icon[icon="ellipsis"] {
  --rvt-icon: var(--ellipsis);
}

.rvt-icon--ellipsis-vertical,
rvt-icon[icon="ellipsis-vertical"] {
  --rvt-icon: var(--ellipsis-vertical);
}

.rvt-icon--envelope,
rvt-icon[icon="envelope"] {
  --rvt-icon: var(--envelope);
}

.rvt-icon--exclamation,
rvt-icon[icon="exclamation"] {
  --rvt-icon: var(--exclamation);
}

.rvt-icon--expand,
rvt-icon[icon="expand"] {
  --rvt-icon: var(--expand);
}
...
.rvt-icon--heart-solid,
rvt-icon[icon="heart-solid"] {
...
.rvt-icon--info-circle,
rvt-icon[icon="info-circle"] {
  --rvt-icon: var(--info-circle);
}

.rvt-icon--lightning,
rvt-icon[icon="lightning"] {
  --rvt-icon: var(--lightning);
}

.rvt-icon--lightning-box,
rvt-icon[icon="lightning-box"] {
  --rvt-icon: var(--lightning-box);
}
...
.rvt-icon--link-external,
rvt-icon[icon="link-external"] {
  --rvt-icon: var(--link-external);
}
...
.rvt-icon--lock-closed,
rvt-icon[icon="lock-closed"] {
  --rvt-icon: var(--lock-closed);
}

.rvt-icon--lock-open,
rvt-icon[icon="lock-open"] {
  --rvt-icon: var(--lock-open);
}

.rvt-icon--magnifying-glass,
rvt-icon[icon="magnifying-glass"] {
  --rvt-icon: var(--magnifying-glass);
}

.rvt-icon--map-pin,
rvt-icon[icon="map-pin"] {
  --rvt-icon: var(--map-pin);
}

.rvt-icon--megaphone,
rvt-icon[icon="megaphone"] {
  --rvt-icon: var(--megaphone);
}
...
.rvt-icon--minus-circle,
rvt-icon[icon="minus-circle"] {
  --rvt-icon: var(--minus-circle);
}
...
.rvt-icon--ordered-list,
rvt-icon[icon="ordered-list"] {
  --rvt-icon: var(--ordered-list);
}
...
.rvt-icon--plus-circle,
rvt-icon[icon="plus-circle"] {
  --rvt-icon: var(--plus-circle);
}

.rvt-icon--printer,
rvt-icon[icon="printer"] {
  --rvt-icon: var(--printer);
}

.rvt-icon--question-mark,
rvt-icon[icon="question-mark"] {
  --rvt-icon: var(--question-mark);
}
...
.rvt-icon--settings,
rvt-icon[icon="settings"] {
  --rvt-icon: var(--settings);
}

.rvt-icon--sidebyside,
rvt-icon[icon="sidebyside"] {
  --rvt-icon: var(--sidebyside);
}
...
.rvt-icon--star-solid,
rvt-icon[icon="star-solid"] {
  --rvt-icon: var(--star-solid);
}
...
.rvt-icon--transfer,
rvt-icon[icon="transfer"] {
  --rvt-icon: var(--transfer);
}

.rvt-icon--transfer-alternate,
rvt-icon[icon="transfer-alternate"] {
  --rvt-icon: var(--transfer-alternate);
}
...
.rvt-icon--user-add,
rvt-icon[icon="user-add"] {
  --rvt-icon: var(--user-add);
}

.rvt-icon--user-add-solid,
rvt-icon[icon="user-add-solid"] {
  --rvt-icon: var(--user-add-solid);
}

.rvt-icon--user-remove,
rvt-icon[icon="user-remove"] {
  --rvt-icon: var(--user-remove);
}

.rvt-icon--user-remove-solid,
rvt-icon[icon="user-remove-solid"] {
  --rvt-icon: var(--user-remove-solid);
}

.rvt-icon--user-solid,
rvt-icon[icon="user-solid"] {
  --rvt-icon: var(--user-solid);
}
...
.rvt-icon--users-group-solid,
rvt-icon[icon="users-group-solid"] {
  --rvt-icon: var(--users-group-solid);
}

.rvt-icon--users-solid,
rvt-icon[icon="users-solid"] {
  --rvt-icon: var(--users-solid);
}
</style>
<script>
